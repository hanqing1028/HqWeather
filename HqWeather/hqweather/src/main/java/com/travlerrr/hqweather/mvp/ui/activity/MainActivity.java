...
import com.travlerrr.hqweather.di.component.DaggerMainComponent;
import com.travlerrr.hqweather.mvp.ui.fragment.DrawerFragment;
import com.travlerrr.hqweather.mvp.contract.MainContract;
import com.travlerrr.hqweather.mvp.presenter.MainPresenter;
...
public class MainActivity extends BaseActivity<MainPresenter> implements MainContract.View {
    ...
    private void setDrawerFragment() {
        ...
        getSupportFragmentManager()    //
                .beginTransaction()
                .add(R.id.fl_drawer_container,new DrawerFragment())
                .commit();
    }
